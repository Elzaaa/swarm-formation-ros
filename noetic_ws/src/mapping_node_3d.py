...
class MappingNode:
    ...
    def draw_heatmap(self,data, path):
        ...
        self.ax2.set_title('Artificial Potential Field Map')
    ...
    def draw_heatmap_1(self):
        c = self.ax3.pcolor(self.follower1_map,cmap='hot', vmax=2500)
        self.ax3.set_title('Follower 1 AP Map')
        self.ax3.set_xlim(125,275)
        self.ax3.set_ylim(125,275)
        return c
    
    def draw_heatmap_2(self):
        c = self.ax4.pcolor(self.follower2_map,cmap='hot', vmax=2500)
        self.ax4.set_title('Follower 2 AP Map')
