...
turtlebot_follower1.set_state_trajectory(state_trajectory=[[0.25, 0.25, 0.785], [0.25, 0.25, 0.785], [0.75, 0.75, 0.785]])
...
if __name__ == "__main__":
	rospy.init_node('ros_controller_node')
	t1 = threading.Thread(target=turtlebot_follower1.spin_trajectory)
